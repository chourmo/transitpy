...
short_description = "Parse, normalize and extract information from one or multiple GTFS files".split("\n")[0]
...
setup(
    ...
    install_requires=["numpy", "scipy", "pandas", "geopandas", "pygeos", "streetpy", "aiohttp"],
